/**
 * ====================================================================================
 * SERVICE WORKER - IGR KIDS (PROTOCOLO CORPORATIVO V71)
 * Code Ahumada 2026
 * ====================================================================================
 */

const CACHE_NAME = 'igr-kids-v71';
...
const PRECACHE_ASSETS = [
  ...
  './icons/icon-512.png',
  './icons/logo-icon.png?v=71',
  './icons/logo-icon.png',
  './icons/app-logo-full.png?v=71',
  ...
  event.waitUntil(
    caches.open(CACHE_NAME).then((cache) => {
      return cache.addAll(PRECACHE_ASSETS).catch((err) => {
        console.warn('[SW v71] Pre-caching partial warning:', err);
      });
    })
  );
});
      ...
      return Promise.all(
        cacheNames.map((cacheName) => {
          if (cacheName !== CACHE_NAME) {
            console.log('[SW v71] Eliminando caché antiguo:', cacheName);
